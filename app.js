...
function renderNextModern() {
  ...
  if (!items.length) {
    ...
    if (state.viewMode === "today") {
      els.nextRelease.innerHTML = `<div class="next-content"><div class="next-label">¡Fin del día! 🎉</div><div class="next-title">Hoy ya no se estrena nada más 😊</div><div class="next-episode">Revisa abajo los estrenos de hoy.</div></div>`;
      return;
    }
